...
def plot_adaptive_fs(out_path: Path, fft_rows: list[dict[str, str]]) -> dict[str, str]:
    ...
    ax.plot(idx, policy_target, "o--", linewidth=1.0, markersize=4, color="#ff7f11", label="8x policy target")
    ax.axhline(40.0, color="0.5", linestyle="--", linewidth=0.9, label="40 Hz reference")
